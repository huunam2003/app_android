...
//    }
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_chitiet, null);
        ChitietAdapter.MyViewHolder myViewHolder = new ChitietAdapter.MyViewHolder(view);
        return myViewHolder;
    }
